...
import { View, Text, Image, TouchableOpacity, ScrollView, Animated, Easing, TouchableHighlight, TextInput } from 'react-native';
...
class EventsListCard extends React.Component {
    ...
    componentDidUpdate(oldProps) {
        ...
        if (newProps.cardState.selectedEvent != oldProps.cardState.selectedEvent){
        ...
        if (newProps.cardState.newCardHeight != oldProps.cardState.newCardHeight){
            this.animateCard();
        }
    }
                ...
                {selectedEvent &&
                    <TouchableOpacity activeOpacity={0.5} style={this.styles.expandCardArea} onPress={this.onPress}>
                        ...
                        <View style={this.styles.selectedEvent}>
                            <TouchableOpacity key={selectedEvent.key} style={this.styles.button} onPress={() => { }}>
                                {selectedEvent.Image && <Image style={this.styles.eventImage} source={{ uri: selectedEvent.Image }} />}
                            ...
                            <View style={this.styles.eventDescription}>
                                <Text style={{ padding: 10 }}>
                                    Id vel populo scriptorem, modus assentior ne nec. Regione salutandi scripserit ut mea. Duis reque percipitur ius cu, in vix eros molestie, mundi splendide sed cu.
                                </Text>
                            </View>
